...
tapetool2 --sorcerer working\testdata.blocks.txt renderAudio working\testdata.300.wav
...
REM Convert it to audio 
tapetool2 --sorcerer working\testdata.blocks.txt renderAudio --baud:1200 working\testdata.1200.wav
